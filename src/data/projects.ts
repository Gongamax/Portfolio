...
export const projects: Project[] = [
  {
    ...
    description: 'Smart Contract Academic Registry - A blockchain-based solution to verify academic credentials and combat phony certifications. Uses smart contracts for automated, secure credential validation with GDPR compliance and seamless system integration.',
    technologies: ['Blockchain', 'Smart Contracts', 'Credential Verification', 'GDPR Compliance', 'System Integration'],
    features: [
  ...
  },
  {
    ...
    description: 'Professional landing page for an appointment setting business featuring modern animations, responsive design, and Calendly integration. Deployed and live on Netlify.',
  ...
  },
  {
    ...
    description: 'Full-stack online multiplayer Gomoku (Five in a Row) game with both web and mobile clients. Features real-time gameplay, user authentication, and cross-platform compatibility with comprehensive backend API.',
    technologies: ['Kotlin', 'Spring Boot', 'React', 'TypeScript', 'Android', 'Nginx'],
    features: [
