                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl p-6 border border-purple-200">
                      <h5 className="text-lg font-bold text-purple-800 mb-2">SCAR Project</h5>
                      <p className="text-purple-700 mb-4 text-sm leading-relaxed">
                        Smart Contract Academic Registry - Blockchain-based credential verification system
                      </p>
                      <div className="flex items-center justify-between">
                        <span className="text-purple-600 font-semibold">Final Grade</span>
                        <span className="text-2xl font-black text-purple-800">18/20</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-white/50">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-2xl p-6 border border-blue-200 text-center">
                    <div className="text-3xl font-black text-blue-800 mb-2">14</div>
                    <div className="text-blue-700 font-semibold">Final Grade</div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-yellow-100 to-orange-100 rounded-2xl p-6 border border-yellow-200 text-center">
                    <div className="text-2xl mb-2">🏆</div>
                    <div className="text-orange-800 font-bold text-sm">Deloitte Merit Award</div>
                    <div className="text-orange-700 text-xs">Academic Excellence</div>
                  </div>
