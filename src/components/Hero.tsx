const Hero = () => {
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16 sm:pt-8"
    >
      <div className="absolute inset-0 bg-gradient-to-b from-slate-50 via-white to-blue-50"></div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 sm:mb-12 relative pt-6 sm:pt-4">
            <div className="w-36 h-36 sm:w-44 sm:h-44 md:w-52 md:h-52 lg:w-60 lg:h-60 xl:w-64 xl:h-64 mx-auto mb-6 sm:mb-8 relative group">
              ...
              <div className="absolute inset-2 bg-white rounded-full flex items-center justify-center shadow-xl transition-all duration-300 overflow-hidden">
                <img
          ...
          <div className="mb-6 sm:mb-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-slate-900 mb-4 sm:mb-6 leading-tight px-4 sm:px-0">
              Gonçalo Frutuoso
            </h1>
            ...
            <div className="relative px-4 sm:px-0">
              ...
              <h3 className="text-base sm:text-lg md:text-xl text-gray-600 flex flex-col sm:flex-row items-center justify-center gap-2 text-center">
                <span className="flex items-center gap-2">
                  ...
                  Currently @ Sky Portugal (Apple Ecosystem)
                  <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                </span>
              </h3>
            </div>
          ...
          <div className="mb-8 sm:mb-12 px-4 sm:px-0">
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto font-medium text-center">
              ...
              and Master's student at
              <span className="text-blue-600 font-semibold">
                {" "}
                Instituto Superior Técnico
              </span>
              , focused on distributed systems, computational biology, and
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center px-4 sm:px-0 w-full sm:w-auto">
            <a
              href="#projects"
              className="group relative inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200"
            >
            ...
            <a
              ...
              className="group relative inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold text-white bg-gray-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold text-white bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200"
            >
            ...
            <a
              href="#contact"
              className="group relative inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold text-gray-700 bg-white/90 border-2 border-gray-300 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200"
            >
